...
public class StartupLocal
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddSpaStaticFiles(configuration => { configuration.RootPath = "ClientApp/build-local"; });
    }
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseEndpoints(endpoints =>
        {
            ...
            endpoints.MapControllerRoute(
                "default",
                "/api/local/{controller}/{action=Index}/{id?}");
        });
        ...
        app.UseSpa(spa =>
        {
            ...
            if (env.IsDevelopment()) spa.UseReactDevelopmentServer("start:local");
        });
    }
}