...
public static class Program
{
    public static void Main(string[] args)
    {
        ...
        app.OnExecute(async () =>
        {
            ...
            if (!securityValue.EndsWith(Path.DirectorySeparatorChar)) securityValue += Path.DirectorySeparatorChar;
    ...
    private static IHostBuilder CreateHostBuilderServer(string[] args)
    {
        return Host.CreateDefaultBuilder(args)
            ...
            }).ConfigureServices((hostContext, services) => { services.AddHostedService<DatasetsWorker>(); });
    }
    ...
    private static IHostBuilder CreateHostBuilderLocal(string[] args)
    {
        return Host.CreateDefaultBuilder(args)
            ...
            .ConfigureWebHostDefaults(webBuilder => { webBuilder.UseStartup<StartupLocal>(); })
