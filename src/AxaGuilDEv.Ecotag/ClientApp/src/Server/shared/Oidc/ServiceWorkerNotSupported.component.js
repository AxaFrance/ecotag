...
const ServiceWorkerNotSupported = () => (
    <div className="oidc-serviceworker" style={style}>
        <div className="oidc-serviceworker__container">
            ...
            <p className="oidc-serviceworker__content">Votre navigateur n’est pas assez sécurisé pour que
                l’authentification fonctionne. Essayez de mettre à jour votre navigateur ou d’utiliser un navigateur
                plus récent.</p>
        </div>
    </div>
);
