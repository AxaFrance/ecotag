...
public static class HttpClientExtensions
{
        ...
        OAuth2ClientCredentialsBaseOptions options)
    {
        ...
        if (discoverClient.IsError) return null;
    ...
    private static string GenerateJwtToken(string audience, OAuth2ClientCredentialsBaseOptions options)
    {
        ...
        var claims = new List<Claim>
        {
            ...
            new(JwtClaimTypes.Issuer, options.ClientId),
            new(JwtClaimTypes.Subject, options.ClientId),
            new(JwtClaimTypes.Audience, audience),
            new(JwtClaimTypes.Expiration, exp, ClaimValueTypes.Integer64)
        };
