...
function Demo({templates = []}) {
    ...
    const onChange = value => {
        if (templates.length > 0) {
            ...
            playAlgoWithCurrentTemplateAsync(templates[state.templateIndex], setState, {
                ...initialState,
        ...
        <Loader mode={state.loaderMode} text={"Your browser is working"}>
            <form className="af-form ri__form-container" name="myform">
                ...
                <p>
                    ...
                    <br/>
                    This component checks the quality of your document entering information systems. This brings several
                    advantages :
                    <br/>
                </p>
                <ul>
                    <li>This makes it possible to “quickly” warn the user that his document is not of good quality and
                        therefore not very readable.
                    </li>
                    <li>This increases the quality of the data received in the systems.</li>
                    <li>The processing of the requested documents needs less calculation and production infrastructure
                        costs are reduced (part of the calculation is carried out in the browser client).
                    </li>
                </ul>
                <p>
                ...
                <div className="ri__form-content">
                    <div className="ri__form">
                        ...
                        <File
                            ...
                            icon="open"
                        />
                        {state.files.length > 0 && state.croppedContoursBase64 == null ? <><h2>No image
                            found</h2></> : null}
                        ...
                        {state.files.length > 0 ? <><h2>Original image(s)</h2>
                            {state.files.map((file, index) => <img key={index} src={file} alt="pdf page"
