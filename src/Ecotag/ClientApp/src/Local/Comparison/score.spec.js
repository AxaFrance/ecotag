...
describe('Check score functions', () => {
    ...
    test('compute total levenshtein', async () => {
        ...
        const expected_0_birthdate = {
            score: 20,
            score_ok: 0,
            score_ko: 2,
            total: 2,
            completeness_left: {ok: 2, ko: 0},
            completeness_right: {ok: 0, ko: 0},
            percentages: {completeness_ok_left: "100.00 %", completeness_ok_right: "n/a", ok: "0 %"}
        };
        const expected_0_document_id = {
            score: 0,
            score_ok: 2,
            score_ko: 0,
            total: 2,
            completeness_left: {ok: 2, ko: 0},
            completeness_right: {ok: 2, ko: 0},
            percentages: {completeness_ok_left: "100.00 %", completeness_ok_right: "100.00 %", ok: "100 %"}
        };
        const expected_0_document_type = {
            score: 6,
            score_ok: 0,
            score_ko: 2,
            total: 2,
            completeness_left: {ok: 2, ko: 0},
            completeness_right: {ok: 2, ko: 0},
            percentages: {completeness_ok_left: "100.00 %", completeness_ok_right: "100.00 %", ok: "0 %"}
        };
        const expected_0_firstname = {
            score: 8,
            score_ok: 0,
            score_ko: 2,
            total: 2,
        ...
        const expected_0_license_validity_date = {
            score: 20,
            score_ok: 0,
            score_ko: 2,
            total: 2,
        ...
        const expected_0_categoryB = {
            score: "n/a",
            score_ok: 0,
            score_ko: 0,
            total: 0,
            completeness_left: {ok: 0, ko: 0},
            completeness_right: {ok: 0, ko: 2},
            percentages: {completeness_ok_left: "n/a", completeness_ok_right: "0.00 %", ok: "n/a"}
        };
        const expected_1_categoryB = {
            score: 0,
            score_ok: 2,
            score_ko: 0,
            total: 2,
        ...
        const expected_1_document_type = {
            score: 0,
            score_ok: 2,
            score_ko: 0,
            total: 2,
