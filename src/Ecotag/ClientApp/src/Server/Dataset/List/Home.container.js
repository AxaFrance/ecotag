...
export const HomeContainer = ({fetch}) => {
    ...
    return <HomeWithResilience {...state} items={items} numberTotalItems={numberTotalItems} filters={filters}
                               onChangePaging={onChangePaging} onChangeFilter={onChangeFilter}/>;
};
