...
export const LabelWithInput = () => <LabelInput forceDisplayMessage={true} message={"message d'erreur type"}
                                                label="Ajouter des labels :" name="recto" id="1" values={currentLabels}
                                                onChange={onChange}/>;
