...
import {Input, InputConstants as Constants, omit, withInput} from '@axa-fr/react-toolkit-form-core';
    ...
    return labels.map((label, index) => (
        <div key={index} className="ft-label__label-container">
            <div style={{backgroundColor: label.color}} className="ft-label__label">
                <LabelOrEditForm label={label} setLabels={setLabels} labels={labels} setShowEditForm={setShowEditForm}
                                 showEditForm={showEditForm}/>
            </div>
