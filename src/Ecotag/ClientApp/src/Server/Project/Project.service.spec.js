import {fetchCreateProject, fetchDeleteProject, fetchProject} from "./Project.service";
...
describe('Project/Add/New.service', () => {
    describe('.fetchCreateProject()', () => {
        ...
        it('should call fetchCreateProject', () => {
            ...
            expect(givenFetch).toHaveBeenCalledWith(`projects`, {
                method: 'POST',
                body: JSON.stringify(givenNewProject)
            });
        });
    });
});
