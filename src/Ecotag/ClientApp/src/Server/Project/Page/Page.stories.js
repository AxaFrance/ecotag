...
const data = {
    ...
    user: {roles: [], nameIdentifier: "S607718"}
};

export default {title: 'Project/Page'};

export const withDefault = () => <Router><Page loaderMode={LoaderModes.none} user={data.user} group={data.group}
                                               users={data.users} dataset={data.dataset} project={data.project}
                                               annotationsStatus={data.annotationStatus}/></Router>;
