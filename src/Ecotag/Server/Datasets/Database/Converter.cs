...
public static class Converter
{
    ...
    public static FileDataModel ToFileDataModel(this FileModel fileModel)
    {
        return new FileDataModel
        {
            ...
            Annotations = fileModel.Annotations == null
                ? new List<AnnotationDataModel>()
                : fileModel.Annotations.Select(annotation => new AnnotationDataModel
                {
            ...
            Reservations = fileModel.Reservations == null
                ? new List<ReservationDataModel>()
                : fileModel.Reservations.Select(reservation => new ReservationDataModel
                {
