...
public interface IFileService
{
    ...
    Task<ResultWithError<FileServiceDataModel, ErrorResult>> DownloadAsync(string blobStorageName, string containerName, string fileName);
    ...
    Task<IDictionary<string, ResultWithError<FileServiceDataModel, ErrorResult>>> GetInputDatasetFilesAsync(
