  ...
  describe('.annotate()', () => {
    ...
    test.each(statusTestCases)(
        ...
        async (message, statusCase) => {
          ...
          await annotate(() => {}, givenDispatch, {})('0001', '0001', {}, '0001', '', statusCase);
          expect(givenDispatch).toHaveBeenCalledTimes(0);
        }
    );
    ...
    test.each(resilienceTestCases)(
        ...
        async (fetchStatus, expectedStatus) => {
          ...
          expect(givenDispatch).toHaveBeenCalledWith({type: 'annotate', data: {status: expectedStatus, annotation: {}, fileId: '0001'}});
        }
    )
  })
});
