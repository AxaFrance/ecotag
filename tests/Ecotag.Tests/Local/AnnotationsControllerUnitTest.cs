...
namespace AxaGuilDEv.Ecotag.Tests.Local
{
    public class AnnotationsControllerUnitTest
    {
        ...
        public async Task ShouldGetFileContent()
        {
            ...
            var expectedResult = JsonConvert.DeserializeObject<MlCli.Program.HttpResult>(fileContent);
            ...
            var httpResult = (result as ObjectResult).Value as MlCli.Program.HttpResult;
